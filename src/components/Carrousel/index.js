...
import { addClass, removeClass } from "../../helpers/formatting/classNameModifier";

export default function Carrousel({ children, refContainer }) {
  ...
  useLayoutEffect(() => {
    ...
    refForwardDragHandler.addEventListener("click", onClik);
    ...
    return () => {
      ...
      refForwardDragHandler.removeEventListener("click", onClik);
      refForwardDragHandler.removeEventListener("transitionend", fnCheckIndex);
    };
  }, [onDragStart, onDragEnd, onDragMove, onClik, fnCheckIndex]);
