    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
          ...
          <div className="slider">
            <div className="thumbnail">
              {Array(5)
                ?.fill()
                .map((_, index) => (
                  <div className="px-10 relative card group" key={index}>
                    <div className={`item  bg-gray-100`}>
                      <div className="rounded-xl item bg-gray-300 animate-pulse"></div>
                    </div>
                  </div>
                ))}
            </div>
        ...
        <div className="flex-1 px-4 md:p-6">
          ...
          <div className="w-36 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
          <div className="w-88 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
          <div className="w-40 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
          <div className="w-96 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
          <div className="w-64 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
          <div className="w-88 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
        </div>
      </div>
    </section>
...
function LoadingSuggestion() {
  return (
    <section className="bg-gray-100 md:px-28 px-10 py-16">
      <div className="container mx-auto">
        ...
        <div className="flex overflow-x-auto mb-4 -mx-3">
          {Array(4)
            ?.fill()
            .map((_, index) => (
              <div className="px-3 flex-none" style={{ width: "320px" }} key={index}>
                <div className="rounded-xl p-4 pb-8 relative bg-white">
                  ...
                  <div className="w-56 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
                  <div className="w-40 h-4 mt-5 bg-gray-300 animate-pulse rounded-full"></div>
                </div>
              </div>
            ))}
