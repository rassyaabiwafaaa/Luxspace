...
export default function ShoppingCart() {
  ...
  return (
    <div className="w-full px-4 mb-4 md:w-8/12 md:mb-0 md:px-10" id="shopping-cart">
      ...
      {Object.keys(state.cart).length === 0 ? (
        ...
        Object.keys(state.cart).map((key) => {
          ...
          return (
            <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1" key={key}>
              <div className="px-4 flex-none">
